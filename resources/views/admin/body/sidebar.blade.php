    ...
    <section class="sidebar ">	
			...
			<div class="ulogo">
				 <a href="index.html">
				  <!-- logo for regular state and mobile devices -->
					 <div class="text-success align-items-center justify-content-center ">					 	
						  <img src="{{asset('backend/images/logo kabat.png')}}" alt="">
      ...
      <ul class="sidebar-menu" data-widget="tree">  
		...
		<li>
          ...
          <i><img src="{{asset('backend/images/dashboard.png')}}" alt=""></i>
			<span>Dashboard</span>
          </a>
        </li>  
        ...
        <li class="treeview">
          <a href="#">
          <i><img src="{{asset('backend/images/user.png')}}" alt=""></i>
            <span>User</span>
        ...
        <li class="treeview">
          <a href="#">
            <i><img src="{{asset('backend/images/posyandu.svg')}}" alt=""></i>
            <span>Posyandu</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-right pull-right"></i>
            </span>
          ...
          <ul class="treeview-menu">
            <li><a href="{{route('posyandu.view')}}"><i class="ti-more"></i>Tampilkan Posyandu</a></li>
            <li><a href="{{route('posyandu.add')}}"><i class="ti-more"></i>Tambah Posyandu</a></li>
          </ul>
        </li>

        <li class="treeview">
          <a href="#">
            <i><img src="{{asset('backend/images/bidan.png')}}" alt=""></i>
            <span>Bidan</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-right pull-right"></i>
            </span>
          ...
          <ul class="treeview-menu">
            <li><a href="{{route('bidan.view')}}"><i class="ti-more"></i>Tampilkan Bidan</a></li>
            <li><a href="{{route('bidan.add')}}"><i class="ti-more"></i>Tambah Bidan</a></li>
          </ul>
        </li>

        <li class="treeview">
          <a href="#">
          <i><img src="{{asset('backend/images/bayi.png')}}" alt=""></i>
            <span>Data Bayi</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-right pull-right"></i>
            </span>
          ...
          <ul class="treeview-menu">
            <li><a href="{{route('bayi.view')}}"><i class="ti-more"></i>Tampilkan Data Bayi</a></li>
            <li><a href="{{route('bayi.add')}}"><i class="ti-more"></i>Tambah Data Bayi</a></li>
          </ul>
        </li>
 
        <li class="treeview">
          <a href="#">
            <i><img src="{{asset('backend/images/penimbangan.png')}}" alt=""></i>
          ...
          <ul class="treeview-menu">
            <li><a href="{{route('penimbangan.view')}}"><i class="ti-more"></i>Tampilkan Penimbangan</a></li>
            <li><a href="{{route('penimbangan.add')}}"><i class="ti-more"></i>Tambah Penimbangan</a></li>
          </ul>
        </li>

        <li class="treeview">
          <a href="#">
            <i><img src="{{asset('backend/images/laporan.png')}}" alt=""></i>
            <span>Laporan</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-right pull-right"></i>
            </span>
          ...
          <ul class="treeview-menu">
            <li><a href="{{route('laporan.view')}}"><i class="ti-more"></i>Download Laporan</a></li>
