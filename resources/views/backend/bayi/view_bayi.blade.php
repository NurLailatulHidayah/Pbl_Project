			...
			<div class="col-12">
			 ...
			 <div class="box">
				<div class="box-header with-border">
				  <h3 class="box-title">Bayi</h3>
                  <a href="{{route('bayi.add') }}" style="float:right;" type="button" class="btn btn-rounded btn-success mb-5">Tambah Data</a>
				</div>
				<!-- /.box-header -->
				<div class="box-body">
					  ...
					  <table id="example1" class="table table-bordered table-striped">
						...
						<tbody>
							...
							<tr>
								...
								<td>{{$bayi->posyandu->nama_posyandu}}</td>
								<td>{{$bayi->gender}}</td>
								<td>{{$bayi->alamat}}</td>
								<td>
