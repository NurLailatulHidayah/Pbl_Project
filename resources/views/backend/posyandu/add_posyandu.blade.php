		 ...
		 <!-- Basic Forms -->
		  <div class="box">
			<div class="box-header with-border">
			  <h4 class="box-title">Tambah Posyandu</h4>
						...
						<div class="row">
							...
							<div class="col-md-6">
								<div class="form-group">
									...
									<div class="controls">
										<input type="text" name="nama_posyandu" class="form-control" required data-validation-required-message="This field is required"> </div>
									<div class="form-control-feedback"><small>Add <code>required</code> attribute to field for required validation.</small></div>
								</div>
							</div>
